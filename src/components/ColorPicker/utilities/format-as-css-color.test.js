...
describe('formatAsCssColor', () => {
  ...
  test.each(/** @type {[ColorHsl, SupportedColorFormat, string][]} */ ([
    [{
      h: 1, s: 1, l: 0.5, a: 1,
    }, 'hsl', 'hsl(360 100% 50% / 1)'],
    [{
      h: 0.75, s: 1, l: 0.5, a: 1,
    }, 'hsl', 'hsl(270 100% 50% / 1)'],
  ...
  test.each(/** @type {[ColorHwb, SupportedColorFormat, string][]} */ ([
    [{
      h: 1, w: 1, b: 1, a: 1,
    }, 'hwb', 'hwb(360 100% 100% / 1)'],
    [{
      h: 0.75, w: 1, b: 1, a: 1,
    }, 'hwb', 'hwb(270 100% 100% / 1)'],
  ...
  test.each(/** @type {[ColorRgb, SupportedColorFormat, string][]} */ ([
    ...
    [{
      r: 1, g: 0, b: 0, a: 0.333,
    }, 'rgb', 'rgb(255 0 0 / 0.33)'],
    [{
      r: 0.5, g: 0.5, b: 0.25, a: 1,
    }, 'rgb', 'rgb(127.5 127.5 63.75 / 1)'],
    [{
      r: 0.5, g: 0.75, b: 0.125, a: 1,
    }, 'rgb', 'rgb(127.5 191.25 31.88 / 1)'],
