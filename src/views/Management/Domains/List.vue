<template>
    <div class="text-center w-2/3 container mx-auto">
        ...
        <div class="w-full flex flex-col justify-center items-center" v-else>
            ...
            <Modal :open="modalOpen">
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            ...
                            <div class="mt-2">
                                <p class="text-sm text-gray-500">
                                    Are you sure you want to delete this domain? This will delete all associated pages as well. This action cannot be undone.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    <button @click="deleteDomain" type="button" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-red-600 text-base font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:ml-3 sm:w-auto sm:text-sm">
                    Delete
                    </button>
...
export default {
    ...
    methods: {
        ...
        deleteDomain(){
            this.modalOpen = false
            this.$store.dispatch("admin/deleteDomain", {domain_id: this.deleteID})
        },
    },
    created() {
        this.getDomains()
